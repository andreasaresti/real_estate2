...
class SalesRequestNoteTypeAllSalesRequestNoteTest extends TestCase
{
     ...
     * @test
     */
    public function it_gets_sales_request_note_type_all_sales_request_notes(): void
    {
        ...
        $response = $this->getJson(
            route(
                'api.sales-request-note-types.all-sales-request-notes.index',
     ...
     * @test
     */
    public function it_stores_the_sales_request_note_type_all_sales_request_notes(): void
    {
        $salesRequestNoteType = SalesRequestNoteType::factory()->create();
        ...
        $response = $this->postJson(
            route(
                'api.sales-request-note-types.all-sales-request-notes.store',
                $salesRequestNoteType
            ),
            $data
        );
