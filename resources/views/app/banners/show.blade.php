        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-partials.card>
                ...
                <div class="mt-4 px-4">
                    ...
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.banners.inputs.title')
                        </h5>
                        <pre>{{ json_encode($banner->title) ?? '-' }}</pre>
                    </div>
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.banners.inputs.description')
                        </h5>
                        <pre>
{{ json_encode($banner->description) ?? '-' }}</pre
                        >
                    </div>
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.banners.inputs.active')
                        </h5>
