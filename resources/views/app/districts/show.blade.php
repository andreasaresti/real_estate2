                ...
                <div class="mt-4 px-4">
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.districts.inputs.ext_code')
                        </h5>
                        <span>{{ $district->ext_code ?? '-' }}</span>
                    </div>
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.districts.inputs.country')
                        </h5>
                        <span>{{ $district->country ?? '-' }}</span>
                    </div>
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.districts.inputs.name')
                        </h5>
                        <pre>{{ json_encode($district->name) ?? '-' }}</pre>
                    </div>
                </div>
