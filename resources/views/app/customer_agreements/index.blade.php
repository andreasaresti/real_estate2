<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.customer_agreements.index_title')
        </h2>
    </x-slot>
                ...
                <div class="block w-full overflow-auto scrolling-touch">
                    <table class="w-full max-w-full mb-4 bg-transparent">
                        ...
                        <tbody class="text-gray-600">
                            @forelse($customerAgreements as $customerAgreement)
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    <div
                                        ...
                                        "
                                    >
                                        @can('update', $customerAgreement)
                                        <a
                                            href="{{ route('customer-agreements.edit', $customerAgreement) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $customerAgreement)
                                        <a
                                            href="{{ route('customer-agreements.show', $customerAgreement) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        $customerAgreement)
                                        <form
                                            action="{{ route('customer-agreements.destroy', $customerAgreement) }}"
                                            method="POST"
