<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.charge_request_collect_monies.index_title')
        </h2>
    </x-slot>
                ...
                <div class="mb-5 mt-4">
                    <div class="flex flex-wrap justify-between">
                        ...
                        <div class="md:w-1/2 text-right">
                            @can('create',
                            App\Models\ChargeRequestCollectMoney::class)
                            <a
                ...
                <div class="block w-full overflow-auto scrolling-touch">
                    <table class="w-full max-w-full mb-4 bg-transparent">
                        ...
                        <tbody class="text-gray-600">
                            @forelse($chargeRequestCollectMonies as
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        $chargeRequestCollectMoney)
                                        <a
                                            href="{{ route('charge-request-collect-monies.edit', $chargeRequestCollectMoney) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        $chargeRequestCollectMoney)
                                        <a
                                            href="{{ route('charge-request-collect-monies.show', $chargeRequestCollectMoney) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        $chargeRequestCollectMoney)
                                        <form
                                            action="{{ route('charge-request-collect-monies.destroy', $chargeRequestCollectMoney) }}"
                                            method="POST"
                            ...
                            <tr>
                                <td colspan="5">
                                    <div class="mt-10 px-4">
                                        {!!
                                        $chargeRequestCollectMonies->render()
                                        !!}
                                    </div>
                                </td>
                            </tr>
