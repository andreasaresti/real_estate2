<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.banner_images.index_title')
        </h2>
    </x-slot>
                        ...
                        <tbody class="text-gray-600">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-right">
                                    <pre>
{{ json_encode($bannerImage->name) ?? '-' }}</pre
                                    >
                                </td>
                                <td class="px-4 py-3 text-right">
                                    <pre>
...
{{ json_encode($bannerImage->button_text) ?? '-' }}</pre
                                ...
                                >
                                    <div
                                        ...
                                        "
                                    >
                                        @can('update', $bannerImage)
                                        <a
                                            href="{{ route('banner-images.edit', $bannerImage) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $bannerImage)
                                        <a
                                            href="{{ route('banner-images.show', $bannerImage) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $bannerImage)
                                        <form
                                            action="{{ route('banner-images.destroy', $bannerImage) }}"
                                            method="POST"
