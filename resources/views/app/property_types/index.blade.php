<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.property_types.index_title')
        </h2>
    </x-slot>
                        ...
                        <tbody class="text-gray-600">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-3 text-left">
                                    {{ $propertyType->ext_code ?? '-' }}
                                </td>
                                <td class="px-4 py-3 text-right">
                                    <pre>
{{ json_encode($propertyType->name) ?? '-' }}</pre
                                    >
                                </td>
                                <td class="px-4 py-3 text-right">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <a
                                            href="{{ route('property-types.edit', $propertyType) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $propertyType)
                                        <a
                                            href="{{ route('property-types.show', $propertyType) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $propertyType)
                                        <form
                                            action="{{ route('property-types.destroy', $propertyType) }}"
                                            method="POST"
