<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.listing_additional_details.index_title')
        </h2>
    </x-slot>
                ...
                <div class="mb-5 mt-4">
                    <div class="flex flex-wrap justify-between">
                        ...
                        <div class="md:w-1/2 text-right">
                            @can('create',
                            App\Models\ListingAdditionalDetail::class)
                            <a
                ...
                <div class="block w-full overflow-auto scrolling-touch">
                    <table class="w-full max-w-full mb-4 bg-transparent">
                        ...
                        <tbody class="text-gray-600">
                            @forelse($listingAdditionalDetails as
...
{{ json_encode($listingAdditionalDetail->value) ?? '-' }}</pre
                                ...
                                >
                                    <div
                                        ...
                                        "
                                    >
                                        @can('update', $listingAdditionalDetail)
                                        <a
                                            href="{{ route('listing-additional-details.edit', $listingAdditionalDetail) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        $listingAdditionalDetail)
                                        <a
                                            href="{{ route('listing-additional-details.show', $listingAdditionalDetail) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        $listingAdditionalDetail)
                                        <form
                                            action="{{ route('listing-additional-details.destroy', $listingAdditionalDetail) }}"
                                            method="POST"
                            ...
                            <tr>
                                <td colspan="5">
                                    <div class="mt-10 px-4">
                                        {!! $listingAdditionalDetails->render()
                                        !!}
                                    </div>
                                </td>
                            </tr>
