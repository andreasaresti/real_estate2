...
class StatusListingsController extends Controller
{
    public function index(Request $request, Status $status): ListingCollection
    {
    ...
    public function store(Request $request, Status $status): ListingResource
    {
        ...
        $listing = $status->listings()->create($validated);
