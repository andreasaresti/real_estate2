...
class CustomerListingsController extends Controller
{
    ...
    public function store(Request $request, Customer $customer): ListingResource
    {
        ...
        $listing = $customer->listings()->create($validated);
