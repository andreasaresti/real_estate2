...
use App\Http\Controllers\Listings\ActiveDeliveryTimesController;
use App\Http\Controllers\Listings\ActiveDistrictController;
use App\Http\Controllers\Listings\ActiveFeaturesController;
use App\Http\Controllers\Listings\ActiveListingsController;
use App\Http\Controllers\Listings\ActiveListingTypesController;
use App\Http\Controllers\Listings\ActiveLocationController;
use App\Http\Controllers\Listings\ActiveMunicipalityController;
use App\Http\Controllers\Listings\ActivePropertyTypesController;
use App\Http\Controllers\Listings\AddMediaController;
use App\Http\Controllers\Listings\AddRemoveFromFavoritesController;
use App\Http\Controllers\Listings\CreateListingController;
...
use App\Http\Controllers\Sales\AcceptSalesRequestController;
use App\Http\Controllers\Sales\AddAppointmentController;
use App\Http\Controllers\Sales\AddListingController;
use App\Http\Controllers\Sales\AddNoteController;
use App\Http\Controllers\Sales\AddSalesRequestController;
use App\Http\Controllers\Sales\ChangeListingTypeController;
use App\Http\Controllers\Sales\CloseDealController;
use App\Http\Controllers\Sales\DeleteListingController;
use App\Http\Controllers\Sales\GetAppointmentsController;
use App\Http\Controllers\Sales\GetListingsController;
use App\Http\Controllers\Sales\GetLostReasonController;
use App\Http\Controllers\Sales\GetNotesController;
use App\Http\Controllers\Sales\GetNoteTypeController;
use App\Http\Controllers\Sales\GetSalesRequestDetailsController;
use App\Http\Controllers\Sales\SignAppointmentController;
use App\Http\Controllers\Sales\UpdateSalesRequestController;
...
// webSalesRequestController
    ...
    Route::post('addnote', [AddNoteController::class, 'add_note']);
    Route::post('salesrequest-getnotes', [GetNotesController::class, 'get_notes']);
    Route::post('salesrequest-addappointments', [AddAppointmentController::class, 'add_appointments']);
    Route::post('salesrequest-getappointments', [GetAppointmentsController::class, 'get_appointments']);
    Route::post('salesrequest-getlistings', [GetListingsController::class, 'get_listings']);
    Route::post('salesrequest-addlisting', [AddListingController::class, 'add_listing']);
    Route::post('salesrequest-deletelisting', [DeleteListingController::class, 'delete_listing']);
    Route::post('salesrequest-changelistingtype', [ChangeListingTypeController::class, 'change_listing_type']);
    Route::post('salesrequest-addsalesrequest', [AddSalesRequestController::class, 'add_sales_request']);
    Route::post('salesrequest-acceptsalesrequest', [AcceptSalesRequestController::class, 'accept_sales_request']);
    Route::post('salesrequest-getsalesrequest', [GetSalesRequestDetailsController::class, 'get_sales_request']);
    Route::post('salesrequest-getsalesrequestdetail', [GetSalesRequestDetailsController::class, 'get_sales_request_detail']);
    Route::post('salesrequest-signappointment', [SignAppointmentController::class, 'sign_appointment']);
    Route::post('salesrequest-updatesalesrequest', [UpdateSalesRequestController::class, 'update_sales_request']);
    Route::post('salesrequest-getlostreason', [GetLostReasonController::class, 'get_lost_reason']);
    Route::post('salesrequest-getnotetype', [GetNoteTypeController::class, 'get_note_type']);
