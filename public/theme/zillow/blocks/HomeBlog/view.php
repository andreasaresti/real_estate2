...
<div data-elementor-type="wp-post" data-elementor-id="105" class="elementor elementor-105" style="margin-top: 50px;">
                    ...
                    <div class="elementor-widget-container">
                        <section id="rh-a9662a4" class="rhea_ele_property_ajax_target rhea_latest_properties_ajax rh_elementor_widget rh_wrapper__news_elementor">
                            <div class="home-properties-section-inner-target">
                                <div class="rh_properties_pagination_append rh_section__news_elementor" id="blogsContent">
                                ...
                                <nav aria-label="..." class="pt-3">
                                    <ul class="pagination mt-0" id="blogs_pagin_content" style="display: flex;justify-content: center;">
    ...
    <input type="hidden" id="blogs_page_index" value="1">
</div>
<script type="text/javascript">
	// window.addEventListener("load", (event) => {
        loadBlogPostsHomeBlog();
	// });
    
    function loadBlogPostsHomeBlog(){
        const sendData = {
            "id":"",
            "blog_id":"",
            "perpage":3,
            "page":document.getElementById("blogs_page_index").value
        };
		...
		xhr.onload = function () {
            ...
            for(i= 0; i<list.length; i++)
            {
                ...
                tempStr = tempStr.substring(0,150) + "...";
                temp +=`<article class="post-45803 post type-post status-publish format-standard has-post-thumbnail hentry category-market-trends tag-sabbianco tag-298 tag-299 rh_blog__post entry-header-margin-fix">
                            <div class="rh_news_module_inner">
                                <div class="rh-wrapper-post-media">
                                    <figure>
                                        <a href="" title="`+ list[i].displayname + `">
                                ...
                                <div class="rh-wrapper-post-contents_elementor">
                                    ...
                                    <p>
                                        <font style="vertical-align: inherit;">
                                            <font style="vertical-align: inherit;">`+ tempStr +`</font>
                                        </font>
                                    </p>
                                </div>
                            </div>
            ...
            document.getElementById("blogsContent").innerHTML = temp;
            ...
            xhr1.onload = function () {
                ...
                if(window.innerWidth > 650){
                    for(j=0;j<list1.length;j++){
                        ...
                        temp1 += `<li class="page-item `+flag+`"><a class="page-link" onclick="loadPageHomeBlog(`+tempIndex+`)">`+list1[j].label+`</a></li>`;
                    }
                }else{
                    for(j=0;j<list1.length;j++){
                        tempUrl = list1[j].url;
                        ...
                        if(j==0 || j == list1.length-1){
                            temp1 += `<li class="page-item"><a class="page-link" onclick="loadPageHomeBlog(`+tempIndex+`)">`+list1[j].label+`</a></li>`;    
                        }else{
                            if(list1[j].active){
                                flag = "active";
                                temp1 += `<li class="page-item `+flag+`"><a class="page-link" onclick="loadPageHomeBlog(`+tempIndex+`)">`+list1[j].label+`</a></li>`;
                ...
                document.getElementById("blogs_pagin_content").innerHTML = temp1;
            }
		}
	}
    function loadPageHomeBlog(index){
        document.getElementById("blogs_page_index").value = index;
		loadBlogPostsHomeBlog();
	}
</script>